...
public class DessertsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<Dish> dessertDishesAdapter = new ArrayAdapter<>(this,
                android.R.layout.simple_list_item_1, dessertDishes);

        dessertsList.setAdapter(dessertDishesAdapter);
    }
}